...
function layoutLetters() {
  ...
  const centeredBox = new THREE.Box3().setFromObject(letters);
...
function resize() {
  ...
  letters.position.y = 0;
}

function applyDragRotation() {
  letters.rotation.x = rotationX;
  letters.rotation.y = rotationY;
  letters.rotation.z = rotationZ;
}
